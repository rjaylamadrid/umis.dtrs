        ...
        <div class="card-body">
            ...
            <div class="col-9">
              <div class="fetch-data">
                ...
                <select name="emp_id" id="emp_info" class="form-control custom-select" onchange="javascript:forced_leave_change(this.value)">
                    ...
                    <option value="{$emp.no};{$emp.employee_picture};{$emp.name};{$emp.position_desc};{$emp.department_desc};fl_">{$emp.name}</option>
                    {/foreach}
                </select>
          ...
          <form action="/leave" method="POST">
            ...
            <div class="form-group">
                <h3 class="card-title">Inclusive Dates</h3>
              <div class="row">
                <div class="col-md-6">
                  <label class="form-label">Start</label><input type="date" class="form-control" name="fl[date_from]" value="" required>
                </div>
                <div class="col-md-6">
                  <label class="form-label">End</label><input type="date" class="form-control" name="fl[date_to]" value="" required>
                </div>
              </div>
            </div>
        </div>
