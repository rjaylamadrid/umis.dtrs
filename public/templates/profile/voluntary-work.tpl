{if $view != "update"}
    <div class="form-group" style="float: right;">
        <a href="{$server}{if $user.is_admin}/employees/update/{$employee->id}/voluntary-work{else}/update/voluntary-work{/if}" class="btn btn-secondary btn-sm ml-2"><i class="fe fe-edit-2"></i> Edit</a>
    </div>
                ...
                <tbody>
                    {foreach from = $employee->voluntary_work item = voluntary_work}
                        <tr>
                            ...
                            <a href="javascript:confirm_delete({$voluntary_work.no},{$voluntary_work.employee_id},'{$tab}')" style="color:#cd201f;" class="btn btn-outline-danger btn-sm"><i class="fe fe-trash"></i></a>
                            </td>
                        </tr>
                    {/foreach}
                </tbody>
